...
import com.app.smartpos.product.ProductDetailsActivity;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            i.putExtra("product_name", productData.get(getAdapterPosition()).get("product_name"));
            i.putExtra("product_supplier", productData.get(getAdapterPosition()).get("product_supplier"));
            i.putExtra("product_buy_price", productData.get(getAdapterPosition()).get("product_buy_price"));
            i.putExtra("product_sell_price", productData.get(getAdapterPosition()).get("product_sell_price"));
