...
public class AddCustomersActivity extends BaseActivity {
    ...
    EditText etxtCustomerName, etxtAddress, etxtCustomerCell, etxtCustomerEmail,outstandingamount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outstandingamount=findViewById(R.id.outstandingbalance);
        ...
        txtAddCustomer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String  outstandingbalance = outstandingamount.getText().toString().trim();
