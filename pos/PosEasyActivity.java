...
public class PosEasyActivity extends BaseActivity {

//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_pos_easy);
//
...
//                    Intent intent=new Intent(PosEasyActivity.this,ScannerActivity.class);
...
//
//
//            final DatabaseAccess databaseAccess = DatabaseAccess.getInstance(PosEasyActivity.this);
//            databaseAccess.open();
//
...
//                txtNoProducts.setVisibility(View.GONE);
//
//                productAdapter = new PosProductAdapter(PosEasyActivity.this, productList);
//
...
//                        txtNoProducts.setVisibility(View.GONE);
//
//                        productAdapter = new PosProductAdapter(PosEasyActivity.this, searchProductList);
//
//                        recyclerView.setAdapter(productAdapter);
//
//
...
//                    Intent intent = new Intent(PosEasyActivity.this, ProductCart.class);
//                    startActivity(intent);
//                    return true;
//
//
